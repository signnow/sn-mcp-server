...
from .embedded_invite import _create_embedded_invite, _create_embedded_invite_from_template
from .create_from_template import _create_from_template
from .embedded_sending import _create_embedded_sending, _create_embedded_sending_from_template
...
def bind(mcp, cfg):
    ...
    def send_invite(
        ...
        orders: Annotated[List[InviteOrder], Field(description="List of orders with recipients")] = []
    ) -> SendInviteResponse:
    ...
    def create_embedded_invite(
        ...
        entity_id: Annotated[str, Field(description="ID of the document or document group")], 
        entity_type: Annotated[Optional[Literal["document", "document_group"]], Field(description="Type of entity: 'document' or 'document_group' (optional). If you're passing it, make sure you know what type you have. If it's not found, try using a different type.")] = None,
        orders: Annotated[List[EmbeddedInviteOrder], Field(description="List of orders with recipients")] = []
    ) -> CreateEmbeddedInviteResponse:
    ...
    def create_from_template(
        ...
        name: Annotated[Optional[str], Field(description="Optional name for the new document group or document (required for template groups)")] = None
    ) -> CreateFromTemplateResponse:
    ...
    async def create_embedded_invite_from_template(
        ...
        entity_type: Annotated[Optional[Literal["template", "template_group"]], Field(description="Type of entity: 'template' or 'template_group' (optional). If you're passing it, make sure you know what type you have. If it's not found, try using a different type.")] = None,
        name: Annotated[Optional[str], Field(description="Optional name for the new document or document group")] = None,
        orders: Annotated[List[EmbeddedInviteOrder], Field(description="List of orders with recipients for the embedded invite")] = []
    ) -> CreateEmbeddedInviteFromTemplateResponse:
