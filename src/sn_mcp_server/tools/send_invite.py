...
from .models import InviteOrder, SendInviteResponse, SendInviteFromTemplateResponse
...
async def _send_invite_from_template(
    entity_id: str,
    entity_type: Optional[Literal["template", "template_group"]],
    name: Optional[str],
    orders: List[InviteOrder],
    token: str,
    client: SignNowAPIClient,
    ...
    # Then send invite
    invite_response = _send_invite(created_entity.entity_id, created_entity.entity_type, orders, token, client)
