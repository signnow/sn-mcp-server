...
def _create_document_group_embedded_invite(client: SignNowAPIClient, token, entity_id, orders, document_group):
    ...
    request_data = SignNowEmbeddedInviteRequest(
        ...
        sign_as_merged=True  # Send as merged document group
    )
