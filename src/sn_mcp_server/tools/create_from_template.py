...
from signnow_client import SignNowAPIClient, DocumentGroupTemplate
...
def _find_template_group(entity_id: str, token: str, client: SignNowAPIClient) -> Optional[DocumentGroupTemplate]:
