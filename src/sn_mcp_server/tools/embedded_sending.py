...
def _create_document_group_embedded_sending(client, token, entity_id, redirect_uri, redirect_target, link_expiration, sending_type):
    ...
    from signnow_client import CreateDocumentGroupEmbeddedSendingRequest as SignNowEmbeddedSendingRequest
...
def _create_embedded_sending(
    ...
    link_expiration: Optional[int],
    sending_type: Optional[str],
    token: str,
