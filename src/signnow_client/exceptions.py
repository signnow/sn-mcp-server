...
class SignNowAPIAuthenticationError(SignNowAPIHTTPError):
    ...
    def __init__(self, message: str = "SignNow API authentication failed", status_code: int = 401, response_data: Optional[Dict[str, Any]] = None):
        super().__init__(message, status_code, response_data)
...
class SignNowAPINotFoundError(SignNowAPIHTTPError):
    ...
    def __init__(self, message: str = "SignNow API resource not found", status_code: int = 404, response_data: Optional[Dict[str, Any]] = None):
        super().__init__(message, status_code, response_data)
...
class SignNowAPIRateLimitError(SignNowAPIHTTPError):
    ...
    def __init__(self, message: str = "SignNow API rate limit exceeded", status_code: int = 429, response_data: Optional[Dict[str, Any]] = None):
        super().__init__(message, status_code, response_data)
...
class SignNowAPIServerError(SignNowAPIHTTPError):
    ...
    def __init__(self, message: str = "SignNow API server error", status_code: int = 500, response_data: Optional[Dict[str, Any]] = None):
        super().__init__(message, status_code, response_data) 