...
class DocumentClientMixin:
    ...
    def get_document_download_link(self, token: str, document_id: str) -> DocumentDownloadLinkResponse:
        ...
        return self._post(
            f"/document/{document_id}/download/link",
            headers=headers,
            validate_model=DocumentDownloadLinkResponse
        )
    ...
    def create_document_from_url(self, token: str, request_data: CreateDocumentFromUrlRequest) -> CreateDocumentFromUrlResponse:
        ...
        return self._post(
            ...
            validate_model=CreateDocumentFromUrlResponse
        )
    ...
    def get_document(self, token: str, document_id: str, include_integration_objects: bool = False) -> DocumentResponse:
        ...
        return self._get(
            ...
            headers=headers,
            params=params,
            validate_model=DocumentResponse
        )
    ...
    def merge_documents(self, token: str, request_data: MergeDocumentsRequest) -> MergeDocumentsResponse:
        ...
        return self._post(
            ...
            headers=headers,
            json_data=request_data.model_dump(exclude_none=True),
            validate_model=MergeDocumentsResponse
        )
    ...
    def get_document_fields(self, token: str, document_id: str) -> GetDocumentFieldsResponse:
        ...
        return self._get(
            f"/v2/documents/{document_id}/fields",
            headers=headers,
            validate_model=GetDocumentFieldsResponse
        )
    ...
    def get_document_history(self, token: str, document_id: str) -> GetDocumentHistoryResponse:
        ...
        return self._get(
            f"/document/{document_id}/historyfull",
            headers=headers,
            validate_model=GetDocumentHistoryResponse
        )

    def create_document_embedded_invite(
        self, 
        token: str, 
        document_id: str, 
    ...
    def generate_document_embedded_invite_link(
        ...
        document_id: str, 
        field_invite_id: str, 
        request_data: GenerateDocumentEmbeddedInviteLinkRequest
    ) -> GenerateDocumentEmbeddedInviteLinkResponse:
        """
    ...
    def create_document_embedded_editor(
        self, 
        token: str, 
        document_id: str, 
        ...
        return self._post(
            f"/v2/documents/{document_id}/embedded-editor",
            headers=headers,
            json_data=request_data.model_dump(exclude_none=True),
            validate_model=CreateEmbeddedEditorResponse
        )

    def create_document_embedded_sending(
        self, 
        token: str, 
        document_id: str, 
        ...
        return self._post(
            f"/v2/documents/{document_id}/embedded-sending",
            headers=headers,
            json_data=request_data.model_dump(exclude_none=True),
    ...
    def create_template(
        ...
        return self._post(
            ...
            headers=headers,
            json_data=request_data.model_dump(exclude_none=True),
            validate_model=CreateTemplateResponse
        )
    ...
    def create_document_from_template(
        ...
        token: str, 
        template_id: str, 
        request_data: Optional[CreateDocumentFromTemplateRequest] = None
    ) -> CreateDocumentFromTemplateResponse:
        """
        ...
        return self._post(
            f"/template/{template_id}/copy",
            headers=headers,
            json_data=json_data,
            validate_model=CreateDocumentFromTemplateResponse
        )

    def create_document_field_invite(
        self, 
        token: str, 
        document_id: str, 
    ...
    def cancel_document_field_invite(
        self, 
        token: str, 
        document_id: str, 
        ...
        return self._put(
            f"/document/{document_id}/fieldinvitecancel",
            headers=headers,
            json_data=request_data.model_dump(exclude_none=True),
            validate_model=CancelDocumentFieldInviteResponse
        )

    def create_document_freeform_invite(
        self, 
        token: str, 
        document_id: str, 
        request_data: CreateDocumentFreeformInviteRequest
    ) -> CreateDocumentFreeformInviteResponse:
        """
