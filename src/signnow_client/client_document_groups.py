...
class DocumentGroupClientMixin:
    ...
    def get_document_group(self, token: str, document_group_id: str) -> GetDocumentGroupResponse:
        ...
        return self._get(
            f"/documentgroup/{document_group_id}",
            headers=headers,
            validate_model=GetDocumentGroupResponse
        )
    ...
    def get_document_group_v2(self, token: str, document_group_id: str) -> GetDocumentGroupV2Response:
        ...
        return self._get(
            f"/v2/document-groups/{document_group_id}",
            headers=headers,
            validate_model=GetDocumentGroupV2Response
        )
    ...
    def create_document_group(self, token: str, request_data: CreateDocumentGroupRequest) -> CreateDocumentGroupResponse:
        ...
        return self._post(
            ...
            validate_model=CreateDocumentGroupResponse
        )
    ...
    def cancel_freeform_invite(self, token: str, document_group_id: str, freeform_invite_id: str, request_data: CancelFreeformInviteRequest) -> bool:
        ...
        self._post(
            f"/v2/document-groups/{document_group_id}/free-form-invites/{freeform_invite_id}/cancel",
            headers=headers,
            json_data=request_data.model_dump(exclude_none=True)
        )
        return True
    ...
    def create_field_invite(self, token: str, document_group_id: str, request_data: CreateFieldInviteRequest) -> CreateFieldInviteResponse:
        ...
        return self._post(
            f"/documentgroup/{document_group_id}/groupinvite",
            headers=headers,
            json_data=request_data.model_dump(exclude_none=True),
            validate_model=CreateFieldInviteResponse
        )
    ...
    def get_field_invite(self, token: str, document_group_id: str, invite_id: str) -> GetFieldInviteResponse:
        ...
        return self._get(
            f"/documentgroup/{document_group_id}/groupinvite/{invite_id}",
            headers=headers,
            validate_model=GetFieldInviteResponse
        )
    ...
    def send_document_group_email(self, token: str, document_group_id: str, request_data: SendEmailRequest) -> bool:
        ...
        self._post(
            f"/v2/document-groups/{document_group_id}/send-email",
            headers=headers,
            json_data=request_data.model_dump(exclude_none=True)
        )
        return True
    ...
    def get_document_group_recipients(self, token: str, document_group_id: str) -> GetRecipientsResponse:
        ...
        return self._get(
            f"/v2/document-groups/{document_group_id}/recipients",
            headers=headers,
            validate_model=GetRecipientsResponse
        )

    def create_document_group_embedded_editor(
        self, 
        token: str, 
        document_group_id: str, 
        request_data: CreateDocumentGroupEmbeddedEditorRequest
    ) -> CreateEmbeddedEditorResponse:
        """
    ...
    def create_document_group_embedded_sending(
        self, 
        token: str, 
        document_group_id: str, 
        request_data: CreateDocumentGroupEmbeddedSendingRequest
    ) -> CreateEmbeddedSendingResponse:
        """
    ...
    def create_document_group_template(
        self, 
        token: str, 
        request_data: CreateDocumentGroupTemplateRequest
    ) -> CreateDocumentGroupTemplateResponse:
        """
        ...
        return self._post(
            "/v2/document-group-templates",
            headers=headers,
            json_data=request_data.model_dump(exclude_none=True),
            validate_model=CreateDocumentGroupTemplateResponse
        )

    def create_document_group_template_from_group(
        self, 
        token: str, 
        doc_group_id: str, 
        request_data: CreateDocumentGroupTemplateFromGroupRequest
    ) -> bool:
        """
        ...
        response = self._post(
            f"/v2/document-groups/{doc_group_id}/document-group-template",
            headers=headers,
            json_data=request_data.model_dump(exclude_none=True)
        )
    ...
    def add_template_to_document_group_template(
        self, 
        token: str, 
        doc_group_template_id: str, 
        request_data: AddTemplateToDocumentGroupTemplateRequest
    ) -> AddTemplateToDocumentGroupTemplateResponse:
        """
    ...
    def get_document_group_template_recipients(
        self, 
        token: str, 
        doc_group_template_id: str
    ) -> GetDocumentGroupTemplateRecipientsResponse:
        ...
        return self._get(
            ...
            headers=headers,
            validate_model=GetDocumentGroupTemplateRecipientsResponse
        )

    def edit_document_group_template_recipients(
        self, 
        token: str, 
        doc_group_template_id: str, 
        request_data: EditDocumentGroupTemplateRecipientsRequest
    ) -> bool:
        """
