...
construction → response parsing / error handling, using respx to intercept httpx calls.

Unlike integration tests (which test tool functions end-to-end), these tests focus on:
- Correct URL construction
- Header passing (Authorization, Content-Type, Accept)
- Response body parsed into the right Pydantic model
- HTTP errors mapped to the correct SignNow exception class
"""
